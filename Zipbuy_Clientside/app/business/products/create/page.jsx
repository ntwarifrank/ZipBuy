...
export default function CreateProduct() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const { data } = await api.post("/api/business/products", formData);
      if (data.success) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">Fill in the details to list a new product on your store.</p>
        </div>
        ...
        <div className="flex items-center gap-3 pt-2">
          <button type="submit" disabled={loading}
            ...
            {loading ? (
              ...
              <><CheckCircle2 size={16} />Create Product</>
            )}
          </button>
          <Link href="/business/products"
