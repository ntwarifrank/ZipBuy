  ...
  const ProductCard = ({ product, index }) => (
    ...
    >
          ...
          <div className='hovered-icon hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 group-hover:flex'>
            <div className='flex flex-row gap-2 sm:gap-3'>
              <div className='p-1 sm:p-2 h-6 w-6 sm:h-8 sm:w-8 rounded-3xl bg-lightGray flex justify-center items-center'>
                <FontAwesomeIcon icon={faHeart} className='text-base sm:text-xs text-darkGray hover:text-alibabaOrange' />
              </div>
              <div className='p-1 sm:p-2 h-6 w-6 sm:h-8 sm:w-8 rounded-3xl bg-lightGray flex justify-center items-center'>
                <FontAwesomeIcon icon={faLayerGroup} className='text-base sm:text-xs text-darkGray hover:text-alibabaOrange' />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-1 px-2 sm:px-3 h-[40%] flex flex-col gap-1">
        ...
        <div className="text-sm sm:text-xs font-semibold text-gray-700 h-[50%] flex flex-row justify-between">
          <div className="flex flex-col">
            ...
            <div className="text-xs sm:text-sm flex flex-row gap-1 sm:gap-3">
              ...
              <div className="flex flex-row items-center">
                <FontAwesomeIcon icon={faStar} className="text-alibabaOrange text-base sm:text-xs" />
          ...
          <div>
            <div onClick={() => addToCart(product._id)} className="w-full text-sm px-2 flex flex-row py-1 text-white rounded-lg duration-200">
              <FontAwesomeIcon icon={faCartPlus} className="w-5 h-5 sm:w-6 sm:h-6 text-xs sm:text-xl cursor-pointer text-gray-400" />
            </div>
          </div>
        </div>
      </div>
  ...
  const HeaderSection = () => (
    <div className='w-full'>
      <div className="ml-2 sm:ml-3 py-2 sm:py-3">
        ...
        <p className="text-xs sm:text-xl font-bold">Best Selling Specific products - Weekly Update</p>
      </div>
